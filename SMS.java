                    ...
                    case 1:
                        ...
                        if (loginAns != null) {
                            ...
                            while (f2) {
                                ...
                                System.out.println("              #4. Rank wise List");
                                System.out.println("              #5. Back to Menu");
                                System.out.println("              =>(Enter choice in 1 to 5)");
                                System.out.println();
                                ...
                                switch (choice) {
                                    ...
                                    default:
                                        System.out.println();
                                        System.out.println("Enter choice btwn given limit..!!");
                                        System.out.println();
                                        break;
                                }
                            }
    ...
    static void Sign_up() {
        ...
        while (bmail) {
            ...
            if (mail.contains("@gmail.com")) {
                ...
                System.out.println("\t\t\t\u001B[31m Invalid Case:Enter valid Phone num\u001b[00m");
                bmail = true;
            }
        }
        String dob = "";
        ...
        while (mo) {
            ...
            phone = sc.next();
            System.out.println("\t\t\t\u001B[32mChecking Phone num... \u001B[00m");
            try {
                Thread.sleep(4000);
            } catch (Exception e) {
                System.out.println("Exception: " + e.getMessage());
